...
const LTest = () => {
  ...
  useEffect(() => {
    fetch("job-problems.json")
      ...
      .then((data) => {
        ...
        console.log("Available tags:", tagArray);
        setAllTags(tagArray);
      })
  ...
  const fetchProblems = async () => {
    try {
      const res = await fetch("job-problems.json");
      ...
      if (level === "Combined") {
        ...
        const hardProblems = data.filter(
